 ...
 */
final class Version20220328174241 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE enregistrement CHANGE modifie_par modifie_par VARCHAR(255) DEFAULT NULL, CHANGE modifie_le modifie_le DATE DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE enregistrement CHANGE cree_par cree_par VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE modifie_par modifie_par VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE modifie_le modifie_le DATE NOT NULL, CHANGE dtype dtype VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
