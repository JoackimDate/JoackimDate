 ...
 */
final class Version20220328170458 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE enregistrement CHANGE cree_par cree_par VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE modifie_par modifie_par VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE dtype dtype VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
